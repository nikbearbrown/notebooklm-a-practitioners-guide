...
![Comparison table of NotebookLM free tier versus Plus tier across sources per notebook, Audio Overviews, custom instructions, notebook analytics, and priority access](images/10-notebooklm-plus-tbl-01.svg)
