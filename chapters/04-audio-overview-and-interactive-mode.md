...
![Two-column comparison of Audio Overview versus Interactive Mode showing what the listener does, what the AI does, how citations work, and best use case for each](images/04-audio-overview-and-interactive-mode-fig-01.svg)
