...
![Three-panel Mind Map use case diagram: orientation (find central nodes), gap check (identify missing concepts), navigation (click nodes to reach source passages)](images/05-mind-map-fig-01.svg)
