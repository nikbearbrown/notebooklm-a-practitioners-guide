...
![Table comparing three advanced NotebookLM outputs — Infographic, Slide Deck, Cinematic Video — showing what each generates, what the user edits, best use case, and age restriction](images/06-infographics-slides-cinematic-video-tbl-01.svg)
